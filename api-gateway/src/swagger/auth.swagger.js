 ...
 *     description: Cria uma nova conta para professor no sistema EduShare
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *                 description: Nome da escola onde leciona
 *               subjects:
 *                 type: array
 *                 items:
 *                   type: string
 *                 example: [Matemática, Física]
 ...
 *   post:
 *     summary: Fazer login
 *     description: Autentica um professor e retorna token JWT
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     description: Retorna informações do perfil do professor autenticado
 *     tags: [Auth]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *     description: Valida se um token JWT é válido e retorna informações do usuário
 *     tags: [Auth]
 *     requestBody:
 *       required: true
 *       content:
